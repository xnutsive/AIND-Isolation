...
- [ ] Read more about Minimax and alpha beta pruning
- [ ] Implement minimax, alphabeta, 
- [ ] Implement tests for my agents with unittest? 
- [ ] Implement custom scores, pass the project tests
- [ ] Implement advanced strategies for pvp
